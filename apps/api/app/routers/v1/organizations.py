...
from app.schemas.organization import OrganizationCreate, OrganizationResponse, InviteMemberRequest
...
async def invite_member(org_id: str, body: InviteMemberRequest, current_user: CurrentUser, session: DbSession):
